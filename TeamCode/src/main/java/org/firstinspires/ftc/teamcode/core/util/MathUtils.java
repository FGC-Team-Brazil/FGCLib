 ...
 *
 * <p>This class can be used to simplify implementations of algorithiims such as odometry and IMU
 * driver based movement.
 */
public class MathUtils {
   ...
   *
   * <p>Useful in PIDs and when it is desired to limit power applied to motors
   *
   * <p>Example: double motorPower = clamp(speedDesired,-0.7,0.7);
   *
   ...
   *
   * <p>Can be used to make sure an angle never goes past the range [-180,180],which is useful for
   * orientation PIDs
   *
   ...
   *
   * <p>Useful for odometry or linear slides
   *
   ...
   * @return meters
   */
  public static double ticksToMeters(
      double ticks, double ticksPerRevolution, double circumference) {
   ...
   */
  public static double metersToTicks(
      double meters, double ticksPerRevolution, double circumference) {
