 ...
 *
 * <p>Position values follow the FTC AprilTag coordinate system relative to the robot center.
 *
 * <ul>
 *   <li><b>X</b> → Horizontal/lateral offset relative to the robot.
 *   <li><b>Y</b> → Forward distance from the robot to the tag.
 *   <li><b>Z</b> → Vertical offset (height) relative to the robot.
 * </ul>
 *
 * <p>Rotation values are measured in degrees.
 */
public class AprilTagDetection {

  /** Represents a 3D transform between the robot center and the camera. */
   ...
   *
   * @return tag metadata name if available, otherwise "Tag #ID".
   */
  ...
  /**
   * Returns the euclidean distance between the robot center and the AprilTag center.
   *
  ...
  /**
   * Returns the X center of the tag inside the camera frame.
   *
  ...
  /**
   * Returns the Y center of the tag inside the camera frame.
   *
  ...
  /**
   * Returns a formatted string representation of this AprilTag detection.
   *
   * <p>Useful for debugging and telemetry output.
   *
