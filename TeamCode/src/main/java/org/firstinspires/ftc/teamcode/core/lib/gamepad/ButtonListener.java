...
/**
 * ButtonListener is a utility class that listens for a button press and runs a Runnable if the
 * button is pressed or a Runnable if the button is not pressed.
 *
 * <p>It can also listen for multiple buttons and do comparisons.
 */
public class ButtonListener {
   ...
   *
   * <p>ButtonBuilder is a builder class that allows for chaining of conditions.
   *
  ...
  public static class ButtonBuilder {
    ...
    public ButtonBuilder and(boolean condition) {
      ...
      ButtonListenerInstance.button =
          ButtonListenerInstance.buttonList.stream().allMatch(Boolean::booleanValue);
      return this;
    }
    ...
    public ButtonBuilder or(boolean condition) {
      ButtonListenerInstance.buttonList.add(condition);
      ButtonListenerInstance.button =
          ButtonListenerInstance.buttonList.stream().anyMatch(Boolean::booleanValue);
      return this;
    }
     ...
     *
     * <p>Its possible pass a lambda expression or a method reference.
     *
