...
/**
 * GamepadButton is a utility class that intermediates the access to the gamepads. The class maps
 * all the buttons of the gamepads, so other classes can use them. <br>
 * It uses the ButtonListener utility class to control the interactions with the buttons Always use
 * the SmartController class instead of this class
 */
public class GamepadButton {
  ...
  public boolean isLeftTriggerPressed() {
    return gamepad.left_trigger > ControllerConstants.TRIGGER_PRESSED_THRESHOLD_VALUE;
  }

  public boolean isRightTriggerPressed() {
    return gamepad.right_trigger > ControllerConstants.TRIGGER_PRESSED_THRESHOLD_VALUE;
  }
