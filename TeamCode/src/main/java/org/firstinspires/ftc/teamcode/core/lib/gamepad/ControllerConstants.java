 ...
 *
 * <p>These values help prevent unintended activations caused by joystick drift and define the
 * minimum trigger travel required to generate a {@link Trigger}.
 */
public class ControllerConstants {
   ...
   *
   * <p>Used to filter small variations caused by sensor noise or joystick centering imperfections.
   */
   ...
   *
   * <p>A value close to {@code 1.0} ensures the trigger must be intentionally pressed before
   * activating commands.
   */
