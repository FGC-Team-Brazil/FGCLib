...
public class RobotContainer extends RobotContainerInternal {
  ...
  public RobotContainer(Gamepad driver, Gamepad operator) {
    super(
        driver, operator, Drivetrain.getInstance(), SubsystemExample.getInstance()
  ...
  public void configureBindings() {
    ...
    driver
        .leftY()
        .or(driver.rightX())
        .whileActive(() -> drivetrain.arcadeDrive(-driver.getLeftY(), driver.getRightX()));
